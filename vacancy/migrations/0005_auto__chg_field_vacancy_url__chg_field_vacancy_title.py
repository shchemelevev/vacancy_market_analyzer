...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vacancy.title'
        db.alter_column(u'vacancy_vacancy', 'title', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Vacancy.title'
        db.alter_column(u'vacancy_vacancy', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
